    ...
    const mailOnClickHandler = () => {
        ...
        return (
            ...
            <div className='text-center dark:bg-[#252128]'>
                ...
                <a href={mailOnClickHandler} onClick={mailOnClickHandler} className='cursor-pointer text-[20px] text-purple dark:text-[#8F88FF] underline underline-offset-2'>{data[language].footer.mail}</a>
